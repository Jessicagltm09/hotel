...
if($this->session->flashdata('berhasil')) {
	echo "<div class='alert alert-success'><span>Check In SUCCESS</span></div>";
}
?>
...
<div class="search-form"><h4><span class="glyphicon glyphicon-search"></span>Seacrh for</h4>
...
<div class="col-lg-9 col-sm-8">
	...
	<h2><?php echo $nomer_kamar;?></h2>  <?php } ?>
	<div class="row">
		<div class="col-lg-8">
...
<div class="col-lg-4">
	<div class="col-lg-12 col-sm-6">
		...
		<h6><span class="glyphicon glyphicon-home"></span>
			<?php echo $nama_kelas_kamar;?></h6> 
		...
		<div class="input-group date form_date col-md-12" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp-input2" data-link-format="yyyy-mm-dd">
			<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
			<input class="form-control" type="text" name="tgl_reservasi_masuk" placeholder="Tanggal Check In">
		</div>

		<br>
		<div class="input-group date form_date col-md-12" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
			<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
			<input class="form-control" type="text" name="tgl_reservasi_keluar" placeholder="Tanggal Check Out">
		</div>
