...
<head>
	...
	<link href="<?php echo base_url();?>asset/global/plugins/uniform/css/uniform.min.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<div class="content">
		...
		<div class="form-actions">
			<button type="submit" class="btn blue pull-right">
				Login <i class="m-icon-swiperight m-icon-white"></i>
			</button>
		</div>
	...
	<div class="copyrigth"><center>
		2019 &copy; Hotel Shangri-LA System.</center>
	</div>
