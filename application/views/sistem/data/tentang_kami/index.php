		 			...
		 			<div class="col-md-9">
		 				<div class="form-group">
		 					...
		 					<div class="col-md-6">
		 						...
		 						<input type="etxt" class="form-control span6 " name="email_tentang_hotel" id="email_tentang_hotel" value="<?php echo $value['email_tentang_hotel'];?>" />
		 					</div>
		 				</div>
		 				</div>
		 			  	...
		 			  	<div class="col-md-9">
		 			  		...
		 			  		<div class="form-group">
		 			  			...
		 			  			<div class="col-md-6">
		 			  				...
		 			  				<input type="text" class="form-control span6 " name="ig" id="ig" value="<?php echo $value['ig'];?>" />
		 			  			</div>
		 			  		</div>
		 			  	</div>
		 			  	...
		 			  	<div class="col-md-9">
		 			  	 ...
		 			  	 <div class="col-md-9">
		 			  		<div class="form-group">
		 			  			...
		 			  			<div class="col-md-9"> Jika Logo Tidak Ada, maka kosongkan saja!,Untuk FB,TW,IG, dan GP http:// jangan Dihapus
		 			  			</div>
		 			  		</div>
		 			  	</div>
		 			  	</div>
