...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift"></i>Add Gambar Kamar</div>
		</div>
		...
		<div class="portlet-body form">
			...
			<div class="form-body">
				...
				<span>File hanya dalam format gif,jpg,png,jpeg dengan max size 3 MB, File gambar tidak boleh kosong
				</span>
			</div>
			...
			<tbody>
				...
				foreach($kamar_gambar->result_array() as $tampil) { ?>
					<tr>
						<td><?php echo $no;?></td>
						  <td>
						  	<a href="<?php echo base_url();?>sistem/kamar_gambar_delete/<?php echo $tampil['id_kamar_gambar'];?>/<?php echo $tampil['kamar_id'];?>" onclick="return confirm('Yakin Ingin Mengahpus?')"><i class="fa fa-times"></i></a>
