 ...
 <div class="row">
 	<div class="col-md-6">
 		<div class="form-group">
 			...
 			<div class="col-md-9">
 				<input type="text" class="form-control" placeholder="" name="telp_reservasi" value="<?php echo $telp_reservasi;?>" diasbled>
 			</div>
 		</div>
 	</div>
 		...
 		<div class="col-md-6">
 			<div class="row">
 				<div class="col-md-offset-3 col-md-9">
 					<button type="submit" class="btn green">Perpanjang 
 					</button>
 				</div>
 			</div>
 		</div>
