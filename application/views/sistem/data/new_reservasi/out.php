...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift"></i>Proses Check Out</div>
		</div>
	</div>
	...
	<div class="portlet-body form">
		...
		<div class="form-body">
			...
			<div class="row">
				...
				<div class="col-md-6">
				<div class="form-group">
				<label class="control-label col-md-3">Alamat</label>s
				<div class="col-md-9">
			...
			<div class="col-md-9">
			<input type="text" class="form-control" name="harga_kamar" value="<?php echo $harga_kamar;?>" diasbled>
			</div>
			</div>
			</div>
			</div>
