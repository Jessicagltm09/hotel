...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift"></i>Edit Galeri</div>
		</div>
		<div class="portlet-body form">

			<?php echo form_open_multipart('sistem/geleri_update/','class="form-horizontal"');?>
			<div class="form-body">
...
<option value="<?php echo $tampil['id_kategori_galeri'];?>" selected="selected">
<?php echo $tampil['nama_kategori_galeri'];?></option>
												</?php 
					...
					<span>
					Kosongkan gambar jika tidak ingin merubahnya.</span>
