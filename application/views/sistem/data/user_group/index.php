...
<div class="row">
	<div class="col-md-12">
		...
		if($this->session->flashdata('hapus')){
			echo "<div class='alert alert-danger'><span>USER GROUP Delete</span>
			</div>";
		}
		else if($this->session->flashdata('berhasil')){
			echo "<div class='alert alert-success'><span>USER GROUP Save</span></div>";
		}

		if($this->session->flashdata('update')){
			echo "<div class='alert alert-success'><span>USER GROUP Update</span>
			</div>";
		}
		else if($this->session->flashdata('ada')){
			echo "<div class='alert alert-danger'><span>USER GROUP Exist</span></div>";
		}
			...
			<div class="portlet-title">
				...
				<div class="table-toolbar">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="btn-group">
								<a class="btn green" href="<?php echo base_url();?>sistem/user_group_tambah"> Add
