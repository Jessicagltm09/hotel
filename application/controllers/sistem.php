...
class Sistem extends CI_Controller {
	...
	public function login(){
		...
		if ($this->form_validation->run()==FALSE) {
			...
			$this->sistem_model->CekLogin($data);
		}
	}
	...
	public function kategori_galeri_simpan(){
		if($this->session->userdata("id_user")!==""){
			$this->form_validation->set_rules('nama_kategori_galeri','Cetegory Gallery','required');
			if($this->form_validation->run()==FALSE)
			{
				$this->template_system->load('template_system','sistem/data/kategori_galeri/add');
			}
				...
				$this->session->set_flashdata('berhasil','oke');
	...
	public function kategori_galeri_delete(){
		if($this->session->userdata("id_user")!==""){
			$id = $this->input->post('id_kategori_galeri');
			$this->sistem_model->DeleteKategoriGaleri($id);
			redirect('sistem/kategori_galeri/delete-success');		
		}
		else{
			redirect('sistem');
		}
	...
	public function kategori_galeri_update(){
		if($this->session->userdata("id_user")!=="") {
			...
			$this->session->set_flashdata('update','oke');
			redirect("sistem/kategori_galeri");
		}
		else{
			redirect('sistem');
	...
	public function galeri_simpan(){
		if($this->session->userdata("id_user")!==""){
			...
			$this->form_validation->set_rules('nama_galeri','Galerry Name','required');
...
public function galeri_update(){
	...
	public function kamar_delete(){
		...
		if($this->session->userdata("id_user")!==""){
			...
			redirect('sistem/kamar/delete-success');
		}
		else{
			redirect('sistem');
		}
